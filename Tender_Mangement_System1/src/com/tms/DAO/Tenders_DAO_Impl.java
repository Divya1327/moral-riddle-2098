...
public class Tenders_DAO_Impl implements Tenders_DAO{
	...
	@Override
	public String registerTenders(int tender_id, String flat_type, int base_price, String furniture,
			String location, String s_date, String e_date) throws TendersDetailsException {
