...
public class Vendor_Tender_DAO_Impl implements Vendor_Tender_DAO{
	...
	public List<Vendor_Tender_details> viewAssignedDetails(int bid_tender) throws TenderAssignedException {
     List<Vendor_Tender_details> list = new ArrayList<>();
					...
					if(rs1.next()) {
						...
						if(x>0) {
							...
							if(rs2.next()) {
								...
								Vendor_Tender_details details = new Vendor_Tender_details(vid, vvname, vgst, vedate, vemail, tenderid, flat, bprice, hop, furn, loc, sd, ed);
