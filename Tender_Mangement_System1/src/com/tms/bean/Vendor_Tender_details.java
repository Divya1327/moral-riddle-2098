...
public class Vendor_Tender_details {
	...
	public Vendor_Tender_details() {
		// TODO Auto-generated constructor stub
	}

	public Vendor_Tender_details(int id, String vname, int gst_no, String edate, String email, int tender_id,
